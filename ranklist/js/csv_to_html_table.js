...
CsvToHtmlTable = {
    init: function (options) {
      ...
      var datatables_options = {"paging": true,"language": {"url": "js/Chinese.json"}};
      //var custom_formatting = options.custom_formatting || [];
      var custom_formatting = [[4, format_link]];
      ...
      $.when($.get(csv_path)).then(
        function(data){      
          ...
          if (allow_download)
            ...
            $("#" + el).append("<p><a class='btn btn-info' href='" + csv_path + "'><i class='glyphicon glyphicon-download'></i> 下载CSV格式数据</a></p>");
